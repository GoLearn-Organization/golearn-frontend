      ...
      <div className="sub-classes">
        {va === true ? (
          ...
          <div className="loading">
            <svg width="50px" height="50px" viewBox="0 0 50 50" fill="#027dff">
              <circle cx="25" cy="2.4" r="3"></circle>
              <circle opacity="0.55" cx="25" cy="47.6" r="3"></circle>
              <circle opacity="0.9" cx="13.7" cy="5.4" r="3"></circle>
              <path
              ...
              <path
                ...
                opacity="0.35"
              ></path>
              <circle opacity="0.7" cx="2.4" cy="25" r="3"></circle>
              <circle opacity="0.2" cx="47.6" cy="25" r="3"></circle>
              <path
